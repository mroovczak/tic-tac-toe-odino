...
const gameModule = (() => {
  ...
  const isMoveLegal = (e) => {
    return (
      null == gameBoard.gameboard[e.target.dataset["x"]][e.target.dataset["y"]]
...
const displayController = (() => {
  ...
  const clearBoard = () => {
    ...
    const deleteAnimation = [{ opacity: "0" }];
  ...
  const drawLine = (cord) => {
    ...
    let by = cord[3];
    let x1 =
      gameboard[ax][ay].getBoundingClientRect().x +
      gameboard[ax][ay].getBoundingClientRect().height / 2;
    let y1 =
      gameboard[ax][ay].getBoundingClientRect().y +
      gameboard[ax][ay].getBoundingClientRect().width / 2;
    let x2 =
      gameboard[bx][by].getBoundingClientRect().x +
      gameboard[bx][by].getBoundingClientRect().height / 2;
    let y2 =
      gameboard[bx][by].getBoundingClientRect().y +
      gameboard[bx][by].getBoundingClientRect().width / 2;
    ...
    lineDiv.innerHTML =
      ...
      "px; height: " +
      lineThickness +
      "; background: black; position: absolute; top: " +
      y1 +
      "px; left: " +
      x1 +
      "px;'></div>";
